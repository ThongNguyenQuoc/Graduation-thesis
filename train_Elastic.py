...
def main(args):
    ...
    if args.resume:
        try:
            ...
            backbone_pth = '/kaggle/input/epoch0y1/pytorch/default/1/22744header.pth'
            backbone.load_state_dict(torch.load(backbone_pth, map_location=torch.device(local_rank), weights_only=True))
